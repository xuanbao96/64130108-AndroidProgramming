...
Tạo Adapter để đưa các nội dung từ nguồn để hiển thị lên các dòng
package xuanbao.edu.listtudien;
...
-Sử dụng mã java để đưa 2 fragment theo cách dynamic
package xuanbao.edu.fragment_dynamic;
...
-Gán background và chỉnh chữ cho Fragment2
<?xml version="1.0" encoding="utf-8"?>
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    xmlns:app="http://schemas.android.com/apk/res-auto"
    xmlns:tools="http://schemas.android.com/tools"
...
-Gán background và chỉnh chữ cho Fragment3
<?xml version="1.0" encoding="utf-8"?>
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    xmlns:app="http://schemas.android.com/apk/res-auto"
    xmlns:tools="http://schemas.android.com/tools"
...
-Xử lý FooterFragment để chuyển giao màn hình qua từng fragment 1,2,3 khi nhấn nút
...
-Code xử lý lắng nghe và bắt sự kiện để duyệt điều kiện để đưa thông báo để hiển thị lên màn hình
